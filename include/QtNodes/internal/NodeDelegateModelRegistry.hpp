...
{
public:
    using RegistryItemPtr = std::shared_ptr<NodeDelegateModel>;
...
public:
    ...
    {
        RegistryItemCreator creator = []() { return std::make_shared<ModelType>(); };
                        ...
                        TypeConverter          typeConverter)
  {
    ...
    std::shared_ptr<NodeDelegateModel> create(QString const &modelName);

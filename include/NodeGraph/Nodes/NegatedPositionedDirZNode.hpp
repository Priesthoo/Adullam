...
class NegatedPositionedDirZNode:public NodeDelegateModel,public NodeInitializer{
private:
std::shared_ptr<AxisNodeData> outputAxis;
std::weak_ptr<PointNodeData> inputPoint;
 gp_Dir axis=gp_Dir(0.0,0.0,-1.0);

public:
NegatedPositionedDirZNode(){
...
QString caption() const override{
    return tr("Negated Positioned Unit Z Direction");  //
}
